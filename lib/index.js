...
*/
setReadOnly( ns, 'reinterpretFloat16', require( '@stdlib/strided-base-reinterpret-float16' ) );
...
*/
setReadOnly( ns, 'reinterpretInt64', require( '@stdlib/strided-base-reinterpret-int64' ) );
...
*/
setReadOnly( ns, 'reinterpretUint64', require( '@stdlib/strided-base-reinterpret-uint64' ) );
