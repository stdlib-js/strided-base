...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/strided-base/tags). For example,

```javascript
ns = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/strided-base@v0.4.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/strided-base/actions/workflows/test.yml/badge.svg?branch=v0.4.1
[test-url]: https://github.com/stdlib-js/strided-base/actions/workflows/test.yml?query=branch:v0.4.1
...
[@stdlib/strided/base/read-dataview]: https://github.com/stdlib-js/strided-base-read-dataview/tree/umd
...
[@stdlib/strided/base/strided2object]: https://github.com/stdlib-js/strided-base-strided2object/tree/umd
...
[@stdlib/strided/base/write-dataview]: https://github.com/stdlib-js/strided-base-write-dataview/tree/umd
